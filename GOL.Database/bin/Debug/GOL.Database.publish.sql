...
GO
:setvar DatabaseName "GOL"
:setvar DefaultFilePrefix "GOL"
...
CREATE TABLE [dbo].[AIRPLANE] (
    ...
    [dt_criacao_registro] SMALLDATETIME NULL,
    PRIMARY KEY CLUSTERED ([id] ASC, [codigo_do_aviao] ASC)
);
